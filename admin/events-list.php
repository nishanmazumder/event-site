        ...
        <div class="nm_main_content">
            ...
            <table class="table table-fixed" id="myTable">
                ...
                <tbody class="nm_tbl_body scrollable-area">
                    ...
                    $query = "SELECT * FROM nm_event_up WHERE status = '1' ORDER BY eve_time ASC LIMIT $start_page, $per_page_post";
    ...
    <?php } else { ?>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <a class="page-link" href="events-list.php?page=1" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <?php for ($i = 1; $i < $total_pages; $i++) { ?>
                    <li class="page-item"><a class="page-link" href="events-list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                    <?php
                }
                ?>
                <li class="page-item">
                    <a class="page-link" href="events-list.php?page=<?php echo $total_pages; ?>" aria-label="Next">
