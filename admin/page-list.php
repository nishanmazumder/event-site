            ...
            <table class="table table-fixed" id="myTable">
                ...
                <tbody class="nm_tbl_body scrollable-area">
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $query = "DELETE FROM nm_page WHERE id = '$pageId'";
                        $result = $db->delete($query);

                        if ($result) {
                            echo '<span class="text-success" style="display:block; margin-bottom: 10px;">Information deleted successfully !</span>';
                    ...
                    $query = "SELECT * FROM nm_page LIMIT $start_page, $per_page_post";
                    ...
                    if ($result) {
                        while ($data = $result->fetch_assoc()) {
                            ...
                            <tr class="">
                                ...
                                <td><?php echo $fm->textLimit($data['page_des'], 100); ?></td>
                                <td><a href="page-add.php?id=<?php echo $data['id']; ?>">Edit</a> || <a href="?id=<?php echo $data['id']; ?>" onclick="confirm('Are u sure want to delete?');">Delete</a></td>
                            </tr>
                            <?php
                        }
                    } else {
    ...
    <?php } else { ?>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                ...
                <li class="page-item">
                    <a class="page-link" href="page-list.php?page=1" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <?php for ($i = 1; $i < $total_pages; $i++) { ?>
                    <li class="page-item"><a class="page-link" href="page-list.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                    <?php
                }
                ?>
                ...
                <li class="page-item">
                    <a class="page-link" href="page-list.php?page=<?php echo $total_pages; ?>" aria-label="Next">
