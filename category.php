...
<div id="nmCategory" class="container-fluid nm-section-category nm-category">
    <div class="row no-gutters">
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 nm-single-inner">
            ...
            $query = "SELECT * FROM nm_event_up WHERE eve_category = '$category' ORDER BY id DESC LIMIT $start_page, $per_page_post";
            ...
            <!---pagination--->
            <?php
            $p_query = "SELECT * FROM nm_event_up WHERE eve_category = '$category' ORDER BY id";
            ...
            <?php } else { ?>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        <li class="page-item">
                            <a class="page-link" href="category.php?page=1" aria-label="Previous">
                        ...
                        ?>
                        <li class="page-item">
                            <a class="page-link" href="category.php?page=<?php echo $total_pages; ?>" aria-label="Next">
